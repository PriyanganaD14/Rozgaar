...
const WhatWhere = () => {
  ...
  return (
    <Form class="form-row align-items-center forms">
    ...
    <div className="col-sm-10 ikons">
      ...
      <input type="text"  className="form-control frmcntrl" id="inlineFormInputName" placeholder="Job-Category"/>
  ...
  <path d="M1 4h14v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4zm7-2.5A2.5 2.5 0 0 0 5.5 4h-1a3.5 3.5 0 1 1 7 0h-1A2.5 2.5 0 0 0 8 1.5z"/>
    ...
    <div className="col-sm-10 my-1 ikons">
      ...
      <input type="text" className="form-control frmcntrl" id="inlineFormInputName" placeholder="Location"/>
